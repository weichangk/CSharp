...
namespace Essential
{
    public class EnumCls
    {
        public string T1()
        {
            var fileAttributes = FileAttributes.ReadOnly | FileAttributes.Hidden;//追加
            fileAttributes = fileAttributes | FileAttributes.System | FileAttributes.Directory;//追加

            fileAttributes = fileAttributes & ~FileAttributes.ReadOnly;//删除
        ...
        public bool T2()
        {
            ...
            return fileAttributes.HasFlag(FileAttributes.ReadOnly);//判断是否有ReadOnly
        }
        ...
        public bool T3()
        {
            var fileAttributes = FileAttributes.ReadOnly | FileAttributes.Hidden;//追加
            fileAttributes = fileAttributes | FileAttributes.System | FileAttributes.Directory;//追加
            return (fileAttributes & FileAttributes.ReadOnly) == FileAttributes.ReadOnly;//判断是否有ReadOnly
        }
    }
    [Flags]
